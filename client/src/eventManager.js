...
export default class EventManager {
  ...
  newUserConnected(message) {
    ...
    this.updateUsersComponent()
    this.updateActivityLogCompoent(`${user.userName} joined!`)
  }

  updateActivityLogCompoent(message) {
    this.componentEmitter.emit(constants.events.app.ACTIVITYLOG_UPDATED,
      message)
  }
